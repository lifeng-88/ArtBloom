...
extension Notification.Name {
    static let artBloomBSidePaymentCallbackReceived = Notification.Name("artBloomBSidePaymentCallbackReceived")
}

final class ArtBloomPaymentCallbackManager {
    static let shared = ArtBloomPaymentCallbackManager()
