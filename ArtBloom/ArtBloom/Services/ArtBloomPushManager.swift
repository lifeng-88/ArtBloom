...
extension Notification.Name {
    static let artBloomBSidePushPayloadReceived = Notification.Name("artBloomBSidePushPayloadReceived")
    static let artBloomBSidePushTokenUpdated = Notification.Name("artBloomBSidePushTokenUpdated")
}

final class ArtBloomPushManager {
    static let shared = ArtBloomPushManager()

    private let defaults = UserDefaults.standard
    private let tokenKey = "artbloom.push.token"
    private let errorKey = "artbloom.push.lastError"
    private let launchPayloadKey = "artbloom.push.launchPayload"
