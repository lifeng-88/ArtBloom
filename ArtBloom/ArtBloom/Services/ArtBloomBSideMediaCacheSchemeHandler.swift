...
final class ArtBloomBSideMediaCacheSchemeHandler: NSObject, WKURLSchemeHandler {
    static let scheme = "app-media"

    private let ioQueue = DispatchQueue(label: "artbloom.media-cache.scheme-handler", qos: .userInitiated, attributes: .concurrent)
    ...
    private func serve(_ urlSchemeTask: WKURLSchemeTask, taskID: ObjectIdentifier) {
        ...
        guard let requestURL = urlSchemeTask.request.url,
              ...
              let fileURL = ArtBloomBSideMediaCache.shared.cachedURL(for: remoteURLString, mediaType: mediaType),
