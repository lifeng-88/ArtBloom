...
extension Notification.Name {
    static let artBloomBSidePaymentTransactionUpdated = Notification.Name("artBloomBSidePaymentTransactionUpdated")
}

@MainActor
final class ArtBloomPaymentManager {
    static let shared = ArtBloomPaymentManager()

    private let defaults = UserDefaults.standard
    private let orderMappingPrefix = "artbloom.iap.order."
    private let payChannelMappingPrefix = "artbloom.iap.payChannel."
