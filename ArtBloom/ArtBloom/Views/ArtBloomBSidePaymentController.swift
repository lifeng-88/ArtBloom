...
final class ArtBloomBSidePaymentController: UIViewController, WKNavigationDelegate {
    private let url: URL
    ...
    private lazy var webView: WKWebView = {
        ...
        ArtBloomBSideConfig.configureWebViewInspectability(webView)
    ...
    func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Void) {
        ...
        if ArtBloomPaymentRedirectReturnURL.matches(navigationURL) {
            didNotifyClose = true
            ArtBloomPaymentCallbackManager.shared.handle(url: navigationURL)
            dismiss(animated: true)
